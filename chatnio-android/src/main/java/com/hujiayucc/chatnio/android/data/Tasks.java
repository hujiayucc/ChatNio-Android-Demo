...
import com.hujiayucc.chatnio.android.bean.Message;
import com.hujiayucc.chatnio.android.bean.TaskBean;
...
import static com.hujiayucc.chatnio.android.bean.Role.getRole;
...
public class Tasks {
     ...
     */
    public List<TaskBean> getTaskList() throws AuthException, FieldException, IOException {
        GetClient client;
     ...
     * @throws FieldException 字段异常
     */
    public TaskBean getTask(int id) throws AuthException, FieldException, IOException {
        GetClient client;
     ...
     * @throws FieldException 字段异常
     */
    public boolean deleteTask(int id) throws AuthException, FieldException, IOException {
        GetClient client;
